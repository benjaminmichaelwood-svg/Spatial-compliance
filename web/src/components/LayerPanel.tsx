import type { ConformanceResult, SurfaceRole, UploadedSurface } from '../types';
...
export default function LayerPanel({ result, visible, onToggle, uploads, surfaceVisible, onToggleSurface }: Props) {
            ...
            {uploadedRoles.map(({ key, label }) => {
              ...
              return (
                ...
                >
                  ...
                  <svg
                    className={`h-3.5 w-3.5 flex-shrink-0 ${isOn ? 'text-indigo-400' : 'text-slate-600'}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={2}
