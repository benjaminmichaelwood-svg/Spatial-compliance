...
// actual crease *rendering* happens per-pixel in the fragment shader below
// (a standard barycentric-wireframe technique, gated per-edge by the crease
// flag) — no lineSegments geometry, no per-edge draw calls.
function buildCreaseGeometry(source: THREE.BufferGeometry, thresholdDeg: number): THREE.BufferGeometry {
